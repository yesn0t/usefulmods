...
| [Krypton Reforged](https://www.curseforge.com/minecraft/mc-mods/krypton-reforged) | Unknown | Krypton Reforged is a Forge port of Krypton a Minecraft mod designed for the Fabric mod loader that implements a suite of optimizations focused on the Minecraft networking stack | TeamDeusVult | Server | Alpha (1) |
...
| [Magnesium, Sulfuric, Hydrogen Reforged](https://www.curseforge.com/members/someoneelsewastaken/projects) | Unknown | Unofficial ports to forge of Sodium and Phosphor respectively. | someoneelsewastaken | ~~----~~ | none |
